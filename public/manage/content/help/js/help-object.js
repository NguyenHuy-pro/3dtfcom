...
$(document).ready(function () {
    $('.tf_m_c_help_object_add').on('click', '.tf_object_add', function () {
        var formObject = $(this).parents('.frm_object_add');
        tf_m_c_HelpObject.add(formObject);
    });
});
...
$(document).ready(function () {
    //update info
    $('.tf_m_c_help_object_edit').on('click', '.tf_object_update', function () {
        var formObject = $(this).parents('.frm_object_update');
        tf_m_c_HelpObject.edit(formObject);
    });
});
...
$(document).ready(function () {
    $('.tf_object').on('click', '.tf_object_delete', function () {
        ...
        tf_m_c_HelpObject.delete(href, objectId);
    });
});