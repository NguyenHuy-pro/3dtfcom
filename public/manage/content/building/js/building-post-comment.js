 ...
 */
var tf_m_c_building_post_comment = {
    //View
...
$(document).ready(function () {
    //delete post
    $('.tf_m_c_building_post_comment').on('click', '.tf_list_object .tf_object_delete', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_building_post_comment.delete(object);
    });

    //view post
    $('.tf_m_c_building_post_comment').on('click', '.tf_list_object .tf_object_view', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_building_post_comment.view(object);
    });
});