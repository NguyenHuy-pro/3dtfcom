...
$(document).ready(function () {
    //view share
    $('.tf_m_c_ads_banner_image').on('click', '.tf_list_object .tf_object_view', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_ads_banner_image.view(object);
    });

    //delete project
    $('.tf_m_c_ads_banner_image').on('click', '.tf_list_object .tf_object_delete', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_ads_banner_image.delete(object);
    });
});
