...
var tf_m_c_ads_position = {
    ...
    add: {
        save: function (form) {
            ...
            var widthObject = $(form).find("select[name='cbWidth']");
            ...
            if (widthObject.val() == 0) {
                alert('Select width size for position ');
                widthObject.focus();
                return false;
            }
...
$(document).ready(function () {
    $('.tf_m_c_ads_position').on('click', '.tf_frm_add .tf_save', function () {
        var form = $(this).parents('.tf_frm_add');
        tf_m_c_ads_position.add.save(form);
    });
...
//---------- ---------- ---------- Status ----------- ---------- ----------
$(document).ready(function () {
    $('.tf_m_c_ads_position').on('click', '.tf_list_object .tf_object_status', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_ads_position.updateStatus(object);
    });
});
...
$(document).ready(function () {
    //view
    $('.tf_m_c_ads_position').on('click', '.tf_list_object .tf_object_view', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_ads_position.view(object);
    });

    //delete
    $('.tf_m_c_ads_position').on('click', '.tf_list_object .tf_object_delete', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_ads_position.delete(object);
    });
});
...
$(document).ready(function () {
    //get form
    $('.tf_m_c_ads_position').on('click', '.tf_list_object .tf_object_edit', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_ads_position.edit.get(object);
    });

    //post edit
    $('body').on('click', '.tf_frm_edit .tf_save', function () {
        var form = $(this).parents('.tf_frm_edit');
        tf_m_c_ads_position.edit.post(form);
    });
