 ...
 */
var tf_m_c_seller_guide_object = {
    //View
    ...
    add: {
        save: function (form) {
            ...
            if (tf_main.tf_checkInputNull(nameObject, 'Enter name')) {
                ...
                if (tf_main.tf_checkInputMaxLength(nameObject, 50, 'Max length of first name is 50 characters')) return false;
            }
...
$(document).ready(function () {
    $('.tf_m_c_seller_guide_object').on('click', '.tf_frm_add .tf_save', function () {
        var form = $(this).parents('.tf_frm_add');
        tf_m_c_seller_guide_object.add.save(form);
    });
...
//---------- ---------- ---------- Status ----------- ---------- ----------
$(document).ready(function () {
    $('.tf_m_c_seller_guide_object').on('click', '.tf_list_object .tf_object_status', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_seller_guide_object.updateStatus(object);
    });
});
...
$(document).ready(function () {
    //view
    $('.tf_m_c_seller_guide_object').on('click', '.tf_list_object .tf_object_view', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_seller_guide_object.view(object);
    });

    //delete
    $('.tf_m_c_seller_guide_object').on('click', '.tf_list_object .tf_object_delete', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_seller_guide_object.delete(object);
    });
});
...
$(document).ready(function () {
    //get form
    $('.tf_m_c_seller_guide_object').on('click', '.tf_list_object .tf_object_edit', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_seller_guide_object.edit.get(object);
    });

    //post edit
    $('body').on('click', '.tf_frm_edit .tf_save', function () {
        var form = $(this).parents('.tf_frm_edit');
        tf_m_c_seller_guide_object.edit.post(form);
    });
