 ...
 */
var tf_m_c_system_province_type = {
    //View
...
$(document).ready(function () {
    $('.tf_m_c_system_province_type').on('click', '.tf_frm_add .tf_save', function () {
        var formObject = $(this).parents('.tf_frm_add');
        tf_m_c_system_province_type.add.save(formObject);
    });
...
//---------- ---------- ---------- Status ----------- ---------- ----------
$(document).ready(function () {
    $('.tf_m_c_system_province_type').on('click', '.tf_list_object .tf_object_status', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_system_province_type.updateStatus(object);
    });
});
...
$(document).ready(function () {
    //view
    $('.tf_m_c_system_province_type').on('click', '.tf_list_object .tf_object_view', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_system_province_type.view(object);
    });

    //delete user
    $('.tf_m_c_system_province_type').on('click', '.tf_list_object .tf_object_delete', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_system_province_type.delete(object);
    });
});
...
$(document).ready(function () {
    //get form
    $('.tf_m_c_system_province_type').on('click', '.tf_list_object .tf_object_edit', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_system_province_type.edit.get(object);
    });

    //post edit
    $('body').on('click', '.tf_frm_edit .tf_save', function () {
        var formObject = $(this).parents('.tf_frm_edit');
        tf_m_c_system_province_type.edit.post(formObject);
    });
