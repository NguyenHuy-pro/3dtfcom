...
$(document).ready(function () {
    $('.tf_m_c_rule_land_rank_filter').on('change', function () {
        ...
        tf_m_c_map_rule_land_rank.filter(href);
    });
});

//---------- ---------- ---------- add new ----------- ---------- ----------
$(document).ready(function () {
    $('.tf_m_c_map_rule_land_rank').on('click', '.tf_frm_add .tf_save', function () {
        var form = $(this).parents('.tf_frm_add');
        tf_m_c_map_rule_land_rank.add.post(form);
    });
});
...
$(document).ready(function () {
    //get form
    $('.tf_m_c_map_rule_land_rank').on('click', '.tf_list_object .tf_object_edit', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_map_rule_land_rank.edit.get(object);
    });

    //post edit
    $('body').on('click', '.tf_frm_edit .tf_save', function () {
        var formObject = $(this).parents('.tf_frm_edit');
        tf_m_c_map_rule_land_rank.edit.post(formObject);
    });
...
$(document).ready(function () {
    //view
    $('.tf_m_c_map_rule_land_rank').on('click', '.tf_list_object .tf_object_view', function () {
        var object = $(this).parents('.tf_object');
        tf_m_c_map_rule_land_rank.view(object);
    });
});