...
?>
<table id="tf_article_detail_comment_content_{!! $commentId !!}" class="tf-article-detail-comment-content table">
    <tr>
        <td class="tf_avatar tf-avatar" rowspan="2">
            <a class="tf-link pull-left" href="{!! route('tf.user.home',$dataUserCommentAlias) !!}">
    ...
    <tr>
        <td class="tf-action text-right" colspan="2">
            ...
            @if($loginStatus)
                <div class="tf_article_detail_comment_content_action tf-article-detail-comment-content-action btn-group">
    ...
    <script type="text/javascript">
        tf_building_service.articlesDetail.comment.setWidthCommentWrap(<?php echo $commentId; ?>);
    </script>
</table>