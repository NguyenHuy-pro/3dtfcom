    ...
    <div class="panel panel-default tf-margin-none">
        ...
        <div class="panel-body">
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
                <form role="form"
                      class="tf_building_service_articles_edit tf-building-service-articles-edit form-horizontal"
                      enctype="multipart/form-data" method="post"
                      action="{!! route('tf.building.services.article.edit.post') !!}">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <input type="hidden" name="txtArticles" value="{!! $dataBuildingArticles->articlesId() !!}" >
