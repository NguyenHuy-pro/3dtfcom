 ...
 * modelSellerGuide
 */
$dataSellerGuide = $modelSellerGuide->infoOfBuilding();
?>
<table class="table">
            ...
            @if(!empty($sellerGuide->video()))
                <tr>
                    <td class="tf-border-none text-center">
                        <em>{!! trans('frontend_seller.guide_building_video_label') !!}</em>
                        <br/>
    ...
    @else
        <tr>
            <td class="tf-border-none">
                <em>{!! trans('frontend_seller.guide_building_notify_null') !!}</em>
            </td>
        </tr>
    @endif
