...
@section('tf_m_c_action_content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 tf-padding-bot-20">
        <form class="tf_frm_edit col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" name="tf_frm_add" enctype="multipart/form-data" method="post"
              role="form" action="{!! route('tf.m.c.system.building-service-type.edit.get',$dataBuildingServiceType->typeId()) !!}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtName"
                       value="{!! $dataBuildingServiceType->name() !!}" placeholder="Enter name">
            </div>
