...
@section('tf_m_c_action_content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <form class="tf_frm_edit col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" method="post" role="form"
              action="{!! route('tf.m.c.system.warning.edit.post',$dataWarning->warningId()) !!}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtName" value="{!! $dataWarning->name() !!}"
