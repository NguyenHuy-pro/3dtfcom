...
@section('tf_m_c_action_content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <form class="tf_frm_edit col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2  col-md-8 col-md-offset-2"
              name="tf_frm_edit" method="post" role="form"
              action="{!! route('tf.m.c.system.department.edit.post',$dataDepartment->departmentId()) !!}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtName" value="{!! $dataDepartment->name() !!}"
                       placeholder="Enter name">
            </div>
            <div class="form-group">
                <label class="control-label">Code <span class="tf-color-red">*</span>:</label>
                <input type="text" class="form-control" name="txtCodeDepartment"
                       value="{!! $dataDepartment->departmentCode() !!}">
            </div>
            <div class="form-group text-center tf-padding-bot-20">
