...
@section('tf_m_c_action_content')
    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
        <h3 class="tf-margin-30">Edit Province type</h3>
    </div>
    <div class="col-xs-12 com-md-12 col-md-12">
        <form class="tf_frm_edit col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" name="tf_frm_edit"
              method="post" role="form"
              action="{!! route('tf.m.c.system.province-type.edit.post', $dataProvinceType->typeId()) !!}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtName"
                       value="{!! $dataProvinceType->name() !!}" placeholder="Enter name">
            </div>
