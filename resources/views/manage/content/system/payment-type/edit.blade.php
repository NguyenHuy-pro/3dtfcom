...
@section('tf_m_c_action_content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <form class="tf_frm_edit col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" name="tf_frm_edit" method="post" role="form"
              action="{!! route('tf.m.c.system.payment-type.edit.post',$dataPaymentType->typeId()) !!}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtName" value="{!! $dataPaymentType->name() !!}"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="10" name="txtDescription"
                          placeholder="Enter description">{!! $dataPaymentType->description() !!}</textarea>
            </div>
