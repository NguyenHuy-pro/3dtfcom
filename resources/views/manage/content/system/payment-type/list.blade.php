    ...
    <div class="row tf-m-c-container-object">
        ...
        <div class="col-md-12 tf-bg tf-color-white ">
            <div class="col-xs-6 col-sm-6 col-md-6 tf-line-height-40">
                Total : {!! $modelPaymentType->totalRecords() !!}
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6 tf-line-height-40 text-right">
                @if($actionStatus)
                    <a href="{!! route('tf.m.c.system.payment-type.add.get') !!}">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 tf_list_object"
             data-href-status="{!! route('tf.m.c.system.payment-type.status') !!}"
             data-href-view="{!! route('tf.m.c.system.payment-type.view') !!}"
             data-href-edit="{!! route('tf.m.c.system.payment-type.edit.get') !!}"
             data-href-del="{!! route('tf.m.c.system.payment-type.delete') !!}">
            <table class="table table-hover">
                ...
                @if(count($dataPaymentType) > 0)
                    ...
                    ?>
                    @foreach($dataPaymentType as $itemPaymentType)
                        <?php
                        $typeId = $itemPaymentType->typeId();
                        $status = $itemPaymentType->status();
                        ?>
                        <tr class="tf_object" data-object="{!! $typeId !!}">
                            ...
                            <td>
                                {!! $itemPaymentType->name() !!}
                            </td>
                            <td>
                                {!! $itemPaymentType->description() !!}
                            </td>
                            <td>
