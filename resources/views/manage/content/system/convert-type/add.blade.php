 ...
 * Time: 11:43 AM
 */
$title = 'Add convert type';
?>
@extends('manage.content.system.convert-type.index')
@section('tf_m_c_container_object')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <form class="tf_frm_add col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" name="tf_frm_add" method="post" role="form"
              action="{!! route('tf.m.c.system.convert-type.add.post') !!}">
            @if (Session::has('notifyAddConvertType'))
                <div class="form-group text-center tf-color-red">
                    {!! Session::get('notifyAddConvertType') !!}
                    <?php
                    Session::forget('notifyAddConvertType');
                    ?>
                </div>
            @endif
            ...
            <div class="form-group text-center">
                ...
                <a href="{!! route('tf.m.c.system.convert-type.list') !!}">
