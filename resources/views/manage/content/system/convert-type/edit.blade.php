...
@section('tf_m_c_action_content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 tf-padding-bot-20">
        <form class="tf_frm_edit col-xs-12 col-sm-10 col-sm-offset-12 col-md-8 col-md-offset-2" name="tf_frm_edit"
              method="post" role="form"
              action="{!! route('tf.m.c.system.convert-type.edit.post',$dataConvertType->typeId()) !!}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="txtName" name="txtName"
                       value="{!! $dataConvertType->name() !!}"
                       placeholder="Enter name">
            </div>
            <div class="form-group">
                <label class="control-label">Description <span class="tf-color-red">*</span>:</label>
                <textarea class="form-control" rows="5" id="txtDescription" name="txtDescription"
                          placeholder="Enter description">{!! $dataConvertType->description() !!}</textarea>
            </div>
