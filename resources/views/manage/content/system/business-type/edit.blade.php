...
@section('tf_m_c_action_content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 tf-padding-bot-20">
        <form class="tf_frm_edit col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" name="tf_frm_edit"
              ...
              action="{!! route('tf.m.c.system.business-type.edit.post',$dataBusinessType->typeId()) !!}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtName"
                       value="{!! $dataBusinessType->name() !!}" placeholder="Enter name">
            </div>
            <div class="form-group">
                <label class="control-label">Description <span class="tf-color-red">*</span>:</label>
                        <textarea class="form-control" rows="10" name="txtDescription"
                                  placeholder="Enter description">{!! $dataBusinessType->description() !!}</textarea>
            </div>
