...
@section('tf_m_c_action_content')
    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
        <h3 class="tf-margin-30">Edit business </h3>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 tf-padding-bot-20">
        <form class="tf_frm_edit col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" name="tf_frm_edit"
              ...
              action="{!! route('tf.m.c.system.business.edit.post',$dataBusiness->businessId()) !!}">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="cbBusinessType">
                    {!! $modelBusinessType->getOption($dataBusiness->typeId()) !!}
                </select>
            </div>
            <div class="form-group">
                <label class="control-label">Name <span class="tf-color-red">*</span>:</label>
                <input type="text" class="form-control" name="txtName" value="{!! $dataBusiness->name() !!}"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="10" name="txtDescription"
                          placeholder="Enter description">{!! $dataBusiness->description() !!}</textarea>
            </div>
