...
@section('tf_m_c_container_object')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <form class="tf_frm_add col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" name="tf_frm_add"
              ...
              action="{!! route('tf.m.c.system.badInfo.add.post') !!}">
            @if (Session::has('notifyAddBadInfo'))
                <div class="form-group text-center tf-color-red">
                    {!! Session::get('notifyAddBadInfo') !!}
                    <?php
                    Session::forget('notifyAddBadInfo');
                    ?>
                </div>
            @endif
            ...
            <div class="form-group text-center">
                ...
                <a href="{!! route('tf.m.c.system.badInfo.list') !!}">
