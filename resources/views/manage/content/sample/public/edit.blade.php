...
@section('tf_m_c_action_content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 tf-padding-20">
        <form class="tf_frm_edit col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" name="tf_frm_edit" method="post"
              enctype="multipart/form-data" role="form"
              action="{!! route('tf.m.c.sample.public.edit.post',$dataPublicSample->sampleId()) !!}">
            ...
            <div class="form-group text-center">
                ...
                <br/>({!! $dataPublicSample->size->name() !!})px
            </div>
            <div class="form-group">
                <div class="form-group">
                    ...
                    <select id="cbPublicType" class="form-control" name="cbPublicType">
                        {!! $modelPublicType->getOption($dataPublicSample->typeId()) !!}
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                ?>
                @include('manage.content.sample.public.select-image',compact('dataSize'))
            </div>
            <div class="form-group text-center">
