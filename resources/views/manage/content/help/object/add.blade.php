...
@section('tf_m_c_help_content')
    <div class="col-md-12 tf_m_c_help_object_add">
        <div class="col-md-12 tf-padding-20 text-center">
            <h3>Add Help Object</h3>
        </div>
        <div class="col-md-12">
            <form class="frm_object_add col-md-8 col-md-offset-2" method="post" role="form" action="{!! route('tf.m.c.help.object.add.post') !!}">
                @if (Session::has('notifyAddHelpObject'))
                    <div class="form-group text-center tf-color-red">
                        {!! Session::get('notifyAddHelpObject') !!}
                        <?php
                        Session::forget('notifyAddHelpObject');
                        ?>
                    </div>
                @endif
