        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12 text-right">
                    ...
                    <span style="color: black;">{!! $dataProvinceProperty->dateBegin() !!}</span>
                </div>
            </div>
            <div class="row">
                    ...
                    <table class="table table-bordered tf-border-none">
                        ...
                        <tr>
                            ...
                            <td class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                {!! $dataProvinceProperty->dateBegin() !!}
                            </td>
                            <td class="col-xs-2 col-sm-2 col-md-2 col-lg-2 text-right">
                                <em>Province</em>
                            </td>
                            <td class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                {!! $dataProvinceProperty->province->name() !!}
                            </td>
                        </tr>
                        <tr>
                            <td class="text-right">
                            ...
                            <td>
                                {!! $dataProvinceProperty->dateEnd() !!}
                            </td>
                            <td class="text-right">
                                <em>Manager</em>
                            </td>
                            <td>
                                {!! $dataProvinceProperty->staff->fullName() !!}
                            </td>
                        </tr>
                    </table>
                </div>
