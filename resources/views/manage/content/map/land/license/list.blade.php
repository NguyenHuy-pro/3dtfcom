...
$title = 'License';
?>
@extends('manage.content.map.land.license.index')
    ...
    <div class="row tf_m_c_map_banner_license tf-m-c-container-object">
        ...
        <div class="tf-bg tf-color-white col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 tf-line-height-40">
                Total : {!! $modelLandLicense->totalRecords()  !!}
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 tf_list_object"
             data-href-view="{!! route('tf.m.c.map.land.license.view') !!}">
            <table class="table table-hover ">
                ...
                @if(count($dataLandLicense) > 0)
                    <?php
                    $perPage = $dataLandLicense->perPage();
                    $currentPage = $dataLandLicense->currentPage();
                    $n_o = ($currentPage == 1) ? 0 : ($currentPage - 1) * $perPage; // set row number
                    ?>
                    @foreach($dataLandLicense as $licenseObject)
                        <tr class="tf_object" data-object="{!! $licenseObject->licenseId() !!}">
                    ...
                    <tr>
                        <td class="text-center" colspan="6">
                            <?php
                            $hFunction->page($dataLandLicense);
                            ?>
                        </td>
                    </tr>
                @endif
