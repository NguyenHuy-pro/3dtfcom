        ...
        <div class="panel-body">
            <div class="row">
                <div class="text-right col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <span style="color: black;">{!! $dataRuleLandRank->createdAt() !!}</span>
                </div>
            </div>
            <div class="row">
                    ...
                    <table class="table table-bordered tf-border-none">
                        <tr>
                            ...
                            <td class="tf-border-top-none col-xs-8 col-sm-9 col-md-10 col-lg-10">
                                ({!! $dataRuleLandRank->size->width().' x '.$dataRuleLandRank->size->height() !!})px
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                {!! $dataRuleLandRank->rank->rankValue() !!}
                            </td>
                        </tr>
