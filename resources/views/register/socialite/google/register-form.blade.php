...
$socialiteUserName = $dataGoogleUser->name;
$socialiteEmail = $dataGoogleUser->email;
$socialiteAvatar = $dataGoogleUser->avatar;



$socialiteFirstName = $dataGoogleUser->user['name']['familyName'];
$socialiteLastName = $dataGoogleUser->user['name']['givenName'];
            ...
            <div class="container tf-padding-top-30 tf-padding-bot-50">
                <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 tf-font-bold">
                        <h3>{!! trans('frontend.register_g_title') !!}</h3>
                    </div>
                    <form id="frmGoogleRegister" name="frmGoogleRegister" role="form" method='post'
                          enctype='multipart/form-data' action="{!! route('tf.register.google.connect') !!}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                            <div id="tf_g_register_notify" class="form-group text-center tf-color-red tf-em-1-5"></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label>
                                            {!! trans('frontend.register_g_label_first_name') !!} <span
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label>
                                            {!! trans('frontend.register_g_label_last_name') !!} <span
                                                    class="tf-color-red">*</span>:
                                        </label>
                            ...
                            <div class="form-group">
                                <label>
                                    {!! trans('frontend.register_g_label_account') !!} <span
                                            class="tf-color-red">*</span>
                                </label>
                                @if($existEmail)
                                    <br/>
                            ...
                            <div class="form-group">
                                <label>
                                    {!! trans('frontend.register_g_label_password') !!} <span
                                            class="tf-color-red">*</span> :
                                </label>
                            ...
                            <div class="form-group">
                                <label>
                                    {!! trans('frontend.register_g_label_gender') !!} <span
                                            class="tf-color-red">*</span>
                                </label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group text-center">
                                <input type="hidden" name="g_id" value="{!! $socialiteCode !!}">
                                <input type="hidden" name="g_name" value="{!! $socialiteUserName !!}">
                                <input type="hidden" name="g_email" value="{!! $socialiteEmail !!}">
                                <input type="hidden" name="g_avatar" value="{!! $socialiteAvatar !!}">
