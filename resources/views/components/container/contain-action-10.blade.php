...
@section('tf_main_action_wrap')
    ...
    <div id="tf_main_action_content_wrap"
         class="col-xs-10 col-xs-offset-1 col-sm-10 col-md-offset-1 col-md-10 col-md-offset-1 tf-position-abs tf-zindex-2 tf-margin-top-40 tf-border-radius-10 tf-padding-none tf-bg-white tf-overflow-auto ">
        {{--contain action form--}}
