...
$email = $dataBannerShare->email();
$shareLink = $dataBannerShare->shareLink();

$dataBannerShareView = $dataBannerShare->infoBannerShareView();
?>
...
@section('tf_main_action_content')
    <div class="tf_action_height_fix col-xs-12 col-sm-12 col-md-12">
        <table class="table">
            ...
            @if(!empty($dataBannerShareView))
                @foreach($dataBannerShareView as $viewObject)
                    <tr>
                        <td>
