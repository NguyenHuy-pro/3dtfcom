...
#content posts
$dataUserBanner = $dataBannerImage->bannerLicense->user;
?>
<div class="row">
                ...
                <div class="col-xs-10 col-sm-8 col-md-8 col-lg-8">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <a class="tf-link-bold media-heading" href="#">
                                {!! $dataUserBanner->fullName() !!}
                            </a>
                            &nbsp;
                            ...
                            <br/>
                            <span class="tf-color-grey">{!! $dataBannerImage->createdAt() !!}</span>
                        </div>
                    </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="tf-padding-bot-10 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <a class="pull-left" href="{!! route('tf.map.banner.access', $dataBannerImage->bannerLicense->bannerId()) !!}">
                        <img class="media-object tf-border tf-border-radius-4" alt="keyword-seo"
                             style="max-width: 100%;border: 1px solid #d7d7d7;"
                             src="{!! $dataBannerImage->pathFullImage() !!}">
                    </a>
                </div>
            </div>
        </div>
