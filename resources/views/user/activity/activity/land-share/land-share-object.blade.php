                ...
                <div class="col-xs-10 col-sm-8 col-md-8 col-lg-8">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <span class="tf-color-grey"> Shared Land </span>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="tf-padding-bot-10 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <a class="pull-left" href="#">
                        <img class="media-object tf-border-radius-4" alt="keyword-seo" style="max-width: 100%;border: 1px solid #d7d7d7;"
                             src="{!! asset('public\imgsample\icon_freeblock.gif') !!}">
                    </a>
                </div>
            </div>
            ...
            {{--comment--}}
            @include('user.activity.activity.land-share.comments.comment-list')
        </div>
