...
<div class="row">
    ...
    <div class="tf-vertical-bottom col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <form class="tf_frm_user_activity_comment input-group" method="post" action="#" style="background-color: whitesmoke;">
    ...
    {{--contain comment--}}
    <div class="tf_user_activity_comment_list col-xs-12 col-sm-12 col-md-12 col-lg-12">
