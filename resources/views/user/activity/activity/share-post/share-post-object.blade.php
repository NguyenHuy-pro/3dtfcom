...
<div class="row">
    <div class="panel panel-default tf-margin-bot-none"
                ...
                <div class="col-xs-10 col-sm-8 col-md-8 col-lg-8">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <span class="tf-color-grey">shared an post of </span>
        ...
        <div class="panel-body">
                ...
                <div class="tf-padding-bot-10 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <a class="pull-left" href="#">
                        <img class="media-object tf-border-radius-4" alt="keyword-seo"
                             ...
                             src="{!! asset('public\imgsample\Jellyfish.jpg') !!}">
                    </a>
            ...
            {{--comment--}}
            @include('user.activity.activity.share-post.comments.comment-list')
        </div>
