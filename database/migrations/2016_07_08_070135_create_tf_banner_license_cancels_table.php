...
class CreateTfBannerLicenseCancelsTable extends Migration {
	...
	public function up()
	{
		Schema::create('tf_banner_license_cancels', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tf_banner_license_cancels');
	}
