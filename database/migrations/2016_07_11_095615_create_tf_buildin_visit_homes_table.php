...
class CreateTfBuildingVisitHomesTable extends Migration {
	...
	public function up()
	{
		Schema::create('tf_building_visit_homes', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tf_buildin_visit_homes');
	}
